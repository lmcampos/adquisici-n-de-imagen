...
def main():
    ...
    puerto_serie = serial.Serial('/dev/ttyS0', 9600)
    ...
    while True:
        if not cola_detener_todos_los_hilos.empty():
           if "detener" == cola_detener_todos_los_hilos.get():
                ...
                #clase lo cierro cuando se ingresa 'q'. Sino debo presionar doble enteralquedarse bloqueado en inputnuevamente  
